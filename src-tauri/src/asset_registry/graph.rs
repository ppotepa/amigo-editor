...
fn domain_order(domain: AssetDomainDto) -> usize {
    match domain {
        ...
        AssetDomainDto::LayeredImage => 5,
        AssetDomainDto::TileSet => 6,
        AssetDomainDto::TileRuleSet => 7,
        AssetDomainDto::Tilemap => 8,
        AssetDomainDto::Material => 9,
        AssetDomainDto::Mesh => 10,
        AssetDomainDto::ParticlePreset => 11,
        AssetDomainDto::CursorPack => 12,
        AssetDomainDto::UiTheme => 13,
        AssetDomainDto::UiDocument => 14,
        AssetDomainDto::UiMenu => 15,
        AssetDomainDto::UiComponent => 16,
        AssetDomainDto::Audio => 17,
        AssetDomainDto::Font => 18,
        AssetDomainDto::Script => 19,
        AssetDomainDto::Raw => 20,
    }
}
