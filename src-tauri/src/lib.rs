...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::delete_mod_project,
            commands::reveal_scene_document,
            commands::get_scene_hierarchy,
            commands::rename_scene,
            commands::add_scene_component,
            commands::add_scene_entity,
            ...
            commands::undo_editor_mode_transaction,
            commands::redo_editor_mode_transaction,
