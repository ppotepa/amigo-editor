...
export function EditorWorkspace() {
  ...
  return (
    <DebugSourceOverlay enabled={readDebugSourcePreference()} source="src/editor/EditorWorkspace.tsx" className="debug-source-root-shell" contentClassName="debug-source-root-content">
